...
MAIN_WND_TITLE      ='Lake simulation'  #имя главного окна
MAIN_WND_HEIGHT     = 600
MAIN_WND_WIDTH      = 1000
...
CONTROL_WND_RECT        = pygame.Rect(680,20,300,500) #left top w h
...
MAP_WND_RECT            = pygame.Rect(0,20,600,500) #left top w h
MAP_WND_BACKGROUND      = 0x282848
