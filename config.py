...
STATE_TRAINING_PAUSE_HANDLE_EVENTS_INTERVAL_MS = 16
#STATE_TRAINING_PLAY_HANDLE_EVENTS_INTERVAL_MS = 50
...
CONTROL_WND_FONT_COLOR  = 0xe7e7e7              # цвет шрифта на контролах
